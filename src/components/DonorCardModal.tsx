  ...
  function handleShare() {
    if (navigator.share) {
      ...
      navigator.clipboard.writeText(
        `I'm a registered ${donor.bloodGroup} blood donor on B-Link! ${donor.totalDonations} donations completed.`,
      )
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border border-red-100 flex flex-col">
        ...
        >
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex flex-col items-end flex-shrink-0">
              ...
              <span className="text-[10px] text-red-200 mt-1 font-semibold uppercase">
                Blood Group
              </span>
            </div>
          </div>
        ...
        <div className="p-6 space-y-5 bg-gradient-to-b from-white to-red-50/40">
          ...
          <div className="space-y-2 text-xs bg-white rounded-2xl p-4 border border-gray-100">
            ...
            <div className="flex items-center justify-between text-gray-600">
              <span className="flex items-center gap-1.5">
                <Phone className="w-3.5 h-3.5 text-gray-400" /> Verified Phone
              </span>
              <span className="font-semibold text-gray-800">{donor.phone}</span>
            </div>
            <div className="flex items-center justify-between text-gray-600">
              <span className="flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-red-500" /> Next
                Eligibility
              </span>
              <span className="font-semibold text-gray-800">
                {isEligible
