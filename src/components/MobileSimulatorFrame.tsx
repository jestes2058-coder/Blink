...
export default function MobileSimulatorFrame({ children, isMobileSimulator }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 py-6 px-2 sm:px-6 flex flex-col items-center justify-center">
      {/* Title info above device */}
      <div className="mb-3 text-center text-xs text-gray-400 flex items-center gap-1.5">
        <Sparkles className="w-3.5 h-3.5 text-red-500" />
        <span>Mobile App Simulator Preview (iPhone 16 Pro Canvas)</span>
      </div>

      {/* Device Body Container */}
      <div className="w-full max-w-[410px] h-[860px] max-h-[92vh] bg-black rounded-[48px] p-3 shadow-[0_25px_70px_rgba(0,0,0,0.8)] border-4 border-gray-800 flex flex-col relative overflow-hidden">
        {/* Inner Screen */}
