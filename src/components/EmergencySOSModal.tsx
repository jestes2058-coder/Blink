  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-red-950/70 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-red-500">
        {/* Urgent Header */}
        <div className="bg-gradient-to-r from-red-700 via-red-800 to-rose-700 p-6 text-white relative">
          <button
            onClick={onClose}
          ...
          <h3 className="text-2xl font-black tracking-tight" style={{ fontFamily: "'DM Serif Display', serif" }}>
            Trigger Urgent Emergency SOS
          </h3>
          <p className="text-xs text-red-100 mt-1">
            Instantly alerts all eligible district donors with highest priority sound & visual banners.
          </p>
        </div>
        ...
        <form onSubmit={handleTriggerSOS} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Rahul Verma (ICU-3)"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Hospital Name & Ward"
                className="w-full px-3 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-xs sm:text-sm focus:ring-2 focus:ring-red-400 focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="pt-2 flex gap-2">
            <button
              type="submit"
              className="flex-1 py-3.5 bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-700 hover:to-rose-800 active:scale-[0.98] text-white font-extrabold text-sm rounded-2xl shadow-lg shadow-red-300 flex items-center justify-center gap-2 transition"
            >
