...
export default function DonorsDirectory({ user, setView }: Props) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 overflow-x-hidden">
      ...
      <div className="bg-white rounded-3xl border border-red-100 shadow-sm p-4 sm:p-6 mb-6 space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search donor name, location..."
              className="w-full pl-10 pr-4 py-2.5 sm:py-3 bg-gray-50 border border-gray-200 rounded-2xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:bg-white transition"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full py-2.5 sm:py-3 px-3 bg-gray-50 border border-gray-200 rounded-2xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:bg-white transition font-medium"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {filteredDonors.map((donor) => {
            ...
            return (
              <div
                key={donor.id}
                className="bg-white rounded-3xl border border-red-100 shadow-sm hover:shadow-md hover:border-red-200 transition-[box-shadow,border-color] duration-150 p-5 flex flex-col justify-between"
              >
                <div>
