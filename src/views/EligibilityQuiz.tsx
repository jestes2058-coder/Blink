  ...
  const questions: Question[] = [
    {
      ...
      description:
        "Standard medical eligibility criteria for blood donor safety.",
      ...
      explanation:
        "Donors must be at least 18 years old and under 65 for routine voluntary donations.",
    },

    {
      ...
      description:
        "Ensures your total blood volume is safe for donating one standard unit (350–450 ml).",
...

    {
      ...
      title:
        "Has it been at least 90 days (3 months) since your last donation?",

      description:
        "Allows your red blood cells and iron stores to fully replenish.",
      ...
      explanation:
        "Whole blood donation requires a 90-day cooldown interval for donor wellness.",
    },

    {
      ...
      title:
        "Are you currently free from acute cold, fever, infection, or major active antibiotics?",
      ...
      explanation:
        "You should be in good general health on the day of donation without acute active infections.",
    },

    {
      ...
      title:
        "Have you had any tattoos, major piercings, or dental surgeries in the past 6 months?",

      description:
        "Standard window period to prevent potential bloodborne transmission risk.",
      ...
      explanation:
        "A 6-month deferral period is standard after tattoo or piercing procedures.",
    },
  ]
          ...
          <div className="text-center max-w-md mx-auto">
            ...
            >
              {isFullyEligible
                ...
                : "Temporary Cooldown or Deferral"}
            </h2>
